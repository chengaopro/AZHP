...
# iterative-clip_RN50-seed.0-clip_RN50-bs16-step18k-hardZoneKey0.2.0.5-rlWeight0.02-critic0.05-bert-bs8/ckpts/save/4
name=${train_alg}-${features}
name=${name}-seed.${seed} 
name=${name}-clip_RN50-bs16-step18k
name=${name}-hardZoneKey0.2.0.5-rlWeight0.02-critic0.05-bert-bs8
outdir=${DATA_ROOT}/SOON/exprs_map/finetune/${name}/ckpts/save/4
...
CUDA_VISIBLE_DEVICES='0' python map_nav_src/soon/main.py $flag  \
      --resume_file ${outdir}/best_val_unseen_house \
      --test --submit
