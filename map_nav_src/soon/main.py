...
def train(args, train_env, val_envs, aug_env=None, rank=-1):
    ...
    for idx in range(start_iter, start_iter+args.iters, args.log_every):
        ...
        if default_gpu:
            ...
            write_to_record_file(
                "\ntotal_actions %d, max_length %d, entropy %.4f, IL_loss %.4f, Point_loss %.4f, low_RL_loss %.4f, high_RL_loss %.4f, policy_loss %.4f, low_critic_loss %.4f, high_critic_loss %.4f" % (
                    total, length, entropy, IL_loss, Point_loss, low_RL_loss, high_RL_loss, policy_loss, low_critic_loss, high_critic_loss),
                record_file
            )
