...
def load_parser():
    ...
    parser.add_argument('--zoner', choices=['hard_zone', 'soft_zone', 'random', 'null'], default='hard_zone')
    parser.add_argument('--zoner_size_for_random', type=int, default=2)
    parser.add_argument('--zoner_ratio', type=float, default=0.2)
    parser.add_argument('--zoner_thres', type=float, default=0.5)
    parser.add_argument('--out_feature_dim', type=int, default=32)
    parser.add_argument("--zoner_part_loss", action="store_true")
